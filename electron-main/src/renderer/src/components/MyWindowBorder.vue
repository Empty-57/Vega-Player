...
<template>
  <div
    id="diy_bar"
    class="*:cursor-pointer fixed w-screen h-11 bg-transparent top-0 left-0 z-20 flex items-center justify-center *:duration-200"
  >
    ...
    <span class="no_drag p-3 flex items-center justify-center">
      <label class="swap swap-rotate">
        ...
        />
        <svg
          class="swap-off stroke-zinc-900 dark:stroke-zinc-200"
          fill="none"
          height="20"
        ...
        <svg
          class="swap-on stroke-zinc-900 dark:stroke-zinc-200"
          fill="none"
          height="20"
          stroke-linecap="round"
          stroke-linejoin="round"
    ...
    <span
      class="no_drag dark:hover:bg-zinc-600/40 hover:bg-zinc-400/20 p-3"
    ...
    <span
      class="no_drag dark:hover:bg-red-800 hover:bg-red-600 p-3 rounded-tr"
